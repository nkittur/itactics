...
Generated: 2026-03-01T04:26:47.862Z
...
| Chronoweaver | Accelerant | Blink Step | Movement | buff_stat | tgt_self | llm | OK |
| Chronoweaver | Accelerant | Shared Haste | Buff | buff_stat, dot_bleed | tgt_single_ally | llm | OK |
| Chronoweaver | Accelerant | Flicker Strike | Attack | dmg_weapon | tgt_single_enemy | llm | OK |
...
| Chronoweaver | Accelerant | Temporal Surge | Ultimate | buff_stat | tgt_aoe_adjacent | llm | OK |
| Chronoweaver | Accelerant | Afterimage | Passive |  | tgt_self | passive | OK |
| Chronoweaver | Accelerant | Infinite Loop | Ultimate | buff_stat | tgt_self | llm | OK |
| Chronoweaver | Entropy | Rust Touch | Attack | dmg_weapon, debuff_vuln | tgt_single_enemy | llm | OK |
| Chronoweaver | Entropy | Wither Bolt | Attack | dmg_spell, dot_poison | tgt_single_enemy | llm | OK |
| Chronoweaver | Entropy | Sap Vitality | Debuff | debuff_stat | tgt_single_enemy | llm | OK |
...
| Chronoweaver | Entropy | Dust to Dust | Attack | dmg_execute | tgt_single_enemy | llm | OK |
| Chronoweaver | Entropy | Entropic Field | AoE | dot_poison | tgt_aoe_adjacent | llm | OK |
| Chronoweaver | Entropy | Age of Ruin | Passive |  | tgt_self | passive | OK |
| Chronoweaver | Entropy | Crumble | Attack | debuff_vuln | tgt_single_enemy | llm | OK |
| Chronoweaver | Entropy | Pandemic | Active | dot_poison | tgt_aoe_adjacent | llm | OK |
| Chronoweaver | Entropy | Temporal Rot | Passive |  | tgt_self | passive | OK |
| Chronoweaver | Entropy | Heat Death | Ultimate | dmg_spell, dmg_execute | tgt_single_enemy | llm | OK |
| Chronoweaver | Paradox | Rewind | Heal | heal_pctDmg | tgt_self | llm | OK |
...
| Chronoweaver | Paradox | Causal Loop | Debuff | debuff_vuln | tgt_single_enemy | llm | OK |
| Chronoweaver | Paradox | Echo Cast | Active | res_apRefund, dot_bleed | tgt_self | llm | OK |
| Chronoweaver | Paradox | Schrodinger | Passive |  | tgt_self | passive | OK |
| Chronoweaver | Paradox | Time Bomb | Attack | dmg_spell | tgt_aoe_adjacent | llm | OK |
| Chronoweaver | Paradox | Fork Reality | Active | dmg_multihit | tgt_self | llm | OK |
...
| Chronoweaver | Paradox | Closed Timelike | Ultimate | heal_pctDmg, buff_stat | tgt_self | llm | OK |
...
| Ironbloom Warden | Thornwall | Root Stance | Stance | buff_dmgReduce, debuff_stat | tgt_self | llm | OK |
...
| Ironbloom Warden | Thornwall | Entangling Wall | Active | dmg_spell, debuff_stat | tgt_aoe_adjacent | llm | OK |
...
| Ironbloom Warden | Thornwall | World Tree | Ultimate | buff_dmgReduce, stance_counter | tgt_self | llm | OK |
| Ironbloom Warden | Overgrowth | Rejuvenate | Heal | heal_pctDmg | tgt_single_ally | llm | OK |
| Ironbloom Warden | Overgrowth | Photosynthesis | Passive |  | tgt_self | passive | OK |
| Ironbloom Warden | Overgrowth | Seedling | Summon | heal_pctDmg | tgt_aoe_adjacent | llm | OK |
...
| Ironbloom Warden | Overgrowth | Verdant Tide | Heal | heal_pctDmg | tgt_aoe_adjacent | llm | OK |
...
| Ironbloom Warden | Overgrowth | Bloom Cascade | Active | heal_pctDmg | tgt_aoe_adjacent | llm | OK |
| Ironbloom Warden | Overgrowth | Gaia's Embrace | Ultimate | heal_pctDmg, debuff_stat | tgt_aoe_adjacent | llm | OK |
| Ironbloom Warden | Rot Herald | Spore Shot | Attack | dmg_weapon, dot_poison | tgt_single_enemy | llm | OK |
| Ironbloom Warden | Rot Herald | Fungal Growth | Summon | dot_poison | tgt_aoe_adjacent | llm | OK |
...
| Ironbloom Warden | Rot Herald | Plague Garden | Active | dot_poison, debuff_stat | tgt_aoe_adjacent | llm | OK |
| Ironbloom Warden | Rot Herald | Parasitic Vine | Attack | dot_poison, heal_pctDmg | tgt_single_enemy | llm | OK |
| Ironbloom Warden | Rot Herald | Necrotic Bloom | Passive |  | tgt_self | passive | OK |
| Ironbloom Warden | Rot Herald | Cordyceps | Debuff | debuff_stat | tgt_single_enemy | llm | OK |
...
| Echo Dancer | Resonance | Requiem | Ultimate | dmg_spell, dmg_execute | tgt_single_enemy | llm | OK |
| Echo Dancer | Silence | Muffle | Debuff | cc_daze | tgt_single_enemy | llm | OK |
| Echo Dancer | Silence | Sound Eater | Stealth | buff_stat | tgt_self | llm | OK |
| Echo Dancer | Silence | Dampening Field | Passive |  | tgt_self | passive | OK |
| Echo Dancer | Silence | Dead Air | Debuff | cc_daze | tgt_aoe_adjacent | llm | OK |
| Echo Dancer | Silence | Ambush | Attack | dmg_weapon, cc_stun, debuff_vuln | tgt_single_enemy | llm | OK |
| Echo Dancer | Silence | Whisper Step | Passive |  | tgt_self | passive | OK |
| Echo Dancer | Silence | Anechoic | Passive |  | tgt_self | passive | OK |
| Echo Dancer | Silence | Void Frequency | Debuff | cc_daze | tgt_single_enemy | llm | OK |
| Echo Dancer | Silence | Ghost Note | Active | buff_stat | tgt_self | llm | OK |
| Echo Dancer | Silence | Total Silence | Active | cc_daze, buff_stat | tgt_aoe_adjacent | llm | OK |
| Echo Dancer | Silence | Erasure | Passive |  | tgt_self | passive | OK |
| Echo Dancer | Silence | The Unheard | Ultimate | buff_stat, buff_dmgReduce | tgt_self | llm | OK |
| Echo Dancer | Cacophony | Screech | Attack | dmg_spell, debuff_stat | tgt_aoe_adjacent | llm | OK |
| Echo Dancer | Cacophony | Bass Drop | Attack | dmg_spell, disp_push | tgt_aoe_adjacent | llm | OK |
| Echo Dancer | Cacophony | Tinnitus | Debuff | debuff_stat | tgt_single_enemy | llm | OK |
| Echo Dancer | Cacophony | Wall of Sound | Active | dmg_spell, cc_stun | tgt_aoe_adjacent | llm | OK |
| Echo Dancer | Cacophony | Discordant Aura | Aura |  | tgt_self | passive | OK |
| Echo Dancer | Cacophony | Shockwave | Attack | dmg_spell | tgt_aoe_adjacent | llm | OK |
| Echo Dancer | Cacophony | Noise Complaint | Active | debuff_stat | tgt_aoe_adjacent | llm | OK |
...
| Echo Dancer | Cacophony | Brown Note | Active | cc_root, dot_burn | tgt_single_enemy | llm | OK |
| Echo Dancer | Cacophony | Sound & Fury | Passive |  | tgt_self | passive | OK |
| Echo Dancer | Cacophony | Symphony of | Ultimate | dmg_weapon, buff_stat | tgt_aoe_adjacent | type-hint | OK |
...
| Bladesinger | Sword Dance | Pivot Slash | Attack | dmg_weapon | tgt_aoe_adjacent | llm | OK |
| Bladesinger | Sword Dance | Dancer's Cadence | Passive |  | tgt_self | passive | OK |
| Bladesinger | Sword Dance | Whirlwind Step | Movement | dmg_weapon, cc_daze | tgt_single_enemy | llm | OK |
...
| Bladesinger | Sword Dance | The Endless Dance | Transform | buff_stat, dmg_multihit | tgt_self | llm | OK |
...
| Bladesinger | Spell Weave | Force Bolt Slash | Active | dmg_spell, dmg_weapon | tgt_single_enemy | llm | OK |
...
| Bladesinger | Spell Weave | Runic Barrage | Active | dmg_multihit, cc_daze | tgt_single_enemy | llm | OK |
| Bladesinger | Spell Weave | Spellblade Mastery | Passive |  | tgt_self | passive | OK |
| Bladesinger | Spell Weave | Phase Cut | Attack | dmg_weapon, debuff_vuln | tgt_single_enemy | llm | OK |
| Bladesinger | Spell Weave | Resonance Overflow | Active | dmg_spell | tgt_aoe_adjacent | llm | OK |
| Bladesinger | Spell Weave | Infinite Weave | Passive |  | tgt_self | passive | OK |
| Bladesinger | Spell Weave | Grand Synthesis | Active | dmg_weapon, dmg_spell | tgt_aoe_adjacent | llm | OK |
...
| Bladesinger | War Chant | Harmonic Chorus | Active | buff_stat | tgt_aoe_adjacent | llm | OK |
| Bladesinger | War Chant | Discordant Note | Active | cc_daze | tgt_single_enemy | llm | OK |
...
| Bladesinger | War Chant | The Eternal War Song | Toggle | buff_stat, buff_dmgReduce | tgt_aoe_adjacent | llm | OK |
| Necrosurgeon | Reanimator | Harvest Limb | Utility | buff_stat, res_apRefund | tgt_self | type-hint | OK |
| Necrosurgeon | Reanimator | Crude Assembly | Summon | dmg_spell | tgt_self | llm | OK |
...
| Necrosurgeon | Reanimator | Composite Horror | Summon | dmg_spell | tgt_self | llm | OK |
| Necrosurgeon | Reanimator | Surgical Upgrade | Active | heal_pctDmg, buff_stat | tgt_self | llm | OK |
...
| Necrosurgeon | Reanimator | Masterwork Abomination | Summon | dmg_spell, dmg_multihit | tgt_self | llm | OK |
...
| Necrosurgeon | Fleshcraft | Full Conversion | Active | buff_dmgReduce, buff_stat | tgt_self | llm | OK |
| Necrosurgeon | Fleshcraft | Adaptive Carapace | Reactive |  | tgt_self | passive | OK |
| Necrosurgeon | Fleshcraft | The Masterwork Self | Transform | buff_dmgReduce, heal_pctDmg, buff_stat | tgt_self | llm | OK |
...
| Necrosurgeon | Soul Harvest | Spectral Shell | Buff | buff_dmgReduce | tgt_self | llm | OK |
...
| Necrosurgeon | Soul Harvest | Soul Detonation | Active | dmg_spell | tgt_aoe_adjacent | llm | OK |
| Necrosurgeon | Soul Harvest | Spectral Minion | Summon | dmg_spell | tgt_self | llm | OK |
...
| Necrosurgeon | Soul Harvest | Soulstorm Engine | Channel | dmg_multihit, dmg_spell | tgt_aoe_adjacent | llm | OK |
...
| Blood Alchemist | Sacrifice | Hemorrhage Wave | Active | dmg_spell, dot_bleed | tgt_aoe_adjacent | llm | OK |
...
| Blood Alchemist | Sacrifice | Blood Nova | Active | dmg_spell | tgt_aoe_adjacent | llm | OK |
...
| Blood Alchemist | Sacrifice | The Final Offering | Active | dmg_spell, heal_pctDmg | tgt_aoe_adjacent | llm | OK |
...
| Blood Alchemist | Hemomancy | Puppet String | Active | disp_push, dmg_spell | tgt_single_enemy | llm | OK |
| Blood Alchemist | Hemomancy | Boil | Debuff | dot_burn, debuff_vuln | tgt_single_enemy | llm | OK |
| Blood Alchemist | Hemomancy | Full Puppet | CC | cc_stun | tgt_single_enemy | llm | OK |
...
| Blood Alchemist | Hemomancy | Sanguine Dominion | Active | debuff_stat, debuff_stat, cc_daze | tgt_aoe_adjacent | llm | OK |
| Blood Alchemist | Transfusion | Life Draw | Heal | dmg_spell, heal_pctDmg | tgt_single_enemy | llm | OK |
| Blood Alchemist | Transfusion | Clot Seal | Heal | heal_pctDmg | tgt_single_ally | llm | OK |
| Blood Alchemist | Transfusion | Blood Bond | Passive |  | tgt_self | passive | OK |
| Blood Alchemist | Transfusion | Sanguine Transfusion | Active | heal_pctDmg | tgt_single_ally | llm | OK |
| Blood Alchemist | Transfusion | Hemorrhage Harvest | Active | heal_pctDmg | tgt_single_enemy | llm | OK |
| Blood Alchemist | Transfusion | Vital Lattice | Buff | buff_dmgReduce | tgt_single_ally | llm | OK |
| Blood Alchemist | Transfusion | Emergency Infusion | Reactive |  | tgt_self | passive | OK |
| Blood Alchemist | Transfusion | Soul Leak | Active | dmg_spell, heal_pctDmg | tgt_aoe_adjacent | llm | OK |
| Blood Alchemist | Transfusion | Vitae Overflow | Passive |  | tgt_self | passive | OK |
| Blood Alchemist | Transfusion | Mass Transfusion | Active | heal_pctDmg | tgt_aoe_adjacent | llm | OK |
| Blood Alchemist | Transfusion | Blood Economy | Passive |  | tgt_self | passive | OK |
| Blood Alchemist | Transfusion | The Eternal Circuit | Channel | buff_dmgReduce, heal_pctDmg | tgt_aoe_adjacent | llm | OK |
...
| Hexblade | Hungering Blade | Blade Hunger | Active | buff_stat, heal_pctDmg | tgt_self | llm | OK |
| Hexblade | Hungering Blade | Living Weapon | Passive |  | tgt_self | passive | OK |
| Hexblade | Hungering Blade | Soul Drink | Attack | dmg_weapon, heal_pctDmg, cc_daze | tgt_single_enemy | llm | OK |
...
| Hexblade | Hungering Blade | Feast Mode | Active | buff_stat, heal_pctDmg | tgt_self | llm | OK |
| Hexblade | Hungering Blade | Satiated Power | Passive |  | tgt_self | passive | OK |
| Hexblade | Hungering Blade | The Infinite Hunger | Active | buff_stat, heal_pctDmg, dmg_weapon | tgt_self | llm | OK |
...
| Hexblade | Spectral Arsenal | Spectral Blade | Summon | dmg_spell | tgt_self | llm | OK |
...
| Hexblade | Spectral Arsenal | Arsenal Expansion | Summon | dmg_spell | tgt_self | llm | OK |
| Hexblade | Spectral Arsenal | Shield Formation | Active | buff_dmgReduce | tgt_self | llm | OK |
| Hexblade | Spectral Arsenal | Spectral Surge | Active | dmg_multihit | tgt_single_enemy | llm | OK |
| Hexblade | Spectral Arsenal | Ghost Lance | Summon | dmg_spell | tgt_aoe_adjacent | llm | OK |
...
| Hexblade | Spectral Arsenal | Blade Tornado | Active | dmg_spell, buff_dmgReduce | tgt_aoe_adjacent | llm | OK |
| Hexblade | Spectral Arsenal | Spectral Clone | Summon | dmg_spell | tgt_single_enemy | llm | OK |
| Hexblade | Spectral Arsenal | The Ghost Armory | Active | dmg_multihit, dmg_spell, buff_stat | tgt_aoe_adjacent | llm | OK |
...
| Berserker | Blood Fury | Crimson God | Transform | dmg_weapon, buff_stat, dmg_weapon | tgt_self | llm | OK |
| Berserker | Warpath | Bull Rush | Movement | dmg_weapon, disp_push | tgt_single_enemy | llm | OK |
| Berserker | Warpath | Cleave | Attack | dmg_weapon | tgt_aoe_adjacent | llm | OK |
| Berserker | Warpath | Momentum | Passive |  | tgt_self | passive | OK |
| Berserker | Warpath | Titan Charge | Movement | dmg_weapon, dmg_weapon | tgt_single_enemy | llm | OK |
| Berserker | Warpath | Whirlwind | Attack | dmg_multihit | tgt_aoe_adjacent | llm | OK |
...
| Berserker | Warpath | Chain Charge | Movement | dmg_weapon, dmg_multihit | tgt_single_enemy | llm | OK |
| Berserker | Warpath | Seismic Slam | Attack | dmg_weapon, cc_stun, disp_push | tgt_aoe_adjacent | llm | OK |
| Berserker | Warpath | Unstoppable Force | Passive |  | tgt_self | passive | OK |
| Berserker | Warpath | Rampage | Active | res_apRefund | tgt_self | llm | OK |
| Berserker | Warpath | The Living Avalanche | Transform | dmg_weapon, buff_stat, buff_dmgReduce | tgt_self | llm | OK |
| Berserker | Primal Howl | Battle Cry | Active | cc_daze, debuff_stat | tgt_aoe_adjacent | llm | OK |
| Berserker | Primal Howl | Primal Presence | Aura |  | tgt_self | passive | OK |
| Berserker | Primal Howl | Taunt | CC | cc_daze, debuff_stat | tgt_single_enemy | llm | OK |
| Berserker | Primal Howl | Howl of Terror | Active | cc_stun, debuff_stat, dot_bleed | tgt_aoe_adjacent | llm | OK |
...
| Berserker | Primal Howl | Crushing Dominance | Debuff | debuff_stat, debuff_vuln | tgt_single_enemy | llm | OK |
| Berserker | Primal Howl | Mass Rout | Active | dmg_weapon, cc_daze, debuff_stat | tgt_aoe_adjacent | llm | OK |
...
| Berserker | Primal Howl | War God's Roar | Active | cc_stun, buff_stat | tgt_aoe_adjacent | llm | OK |
| Berserker | Primal Howl | Apex Predator | Transform | debuff_stat, buff_stat, cc_daze | tgt_aoe_adjacent | llm | OK |
...
| Monk | Iron Fist | Armor Crack | Attack | dmg_weapon, debuff_vuln | tgt_single_enemy | llm | OK |
...
| Monk | Flowing Water | Ocean's Wrath | Active | buff_stat, stance_counter, dmg_weapon | tgt_self | llm | OK |
...
| Monk | Inner Fire | Wave of Force | Attack | dmg_spell, disp_push | tgt_aoe_adjacent | llm | OK |
| Monk | Inner Fire | Ki Explosion | Active | dmg_spell | tgt_aoe_adjacent | llm | OK |
| Monk | Inner Fire | Focused Beam | Channel | dmg_spell | tgt_single_enemy | llm | OK |
| Monk | Inner Fire | Ki Resonance | Passive |  | tgt_self | passive | OK |
| Monk | Inner Fire | Spirit Bomb | Channel | dmg_spell | tgt_aoe_adjacent | llm | OK |
| Monk | Inner Fire | Inner Supernova | Active | dmg_spell, disp_push | tgt_aoe_adjacent | llm | OK |
| Monk | Inner Fire | Transcendent Ki | Transform | dmg_spell, buff_stat, dmg_spell | tgt_self | llm | OK |
...
| Ranger | Dead Eye | Tungsten Tip | Attack | dmg_weapon, debuff_vuln | tgt_single_enemy | llm | OK |
| Ranger | Dead Eye | Headshot Protocol | Passive |  | tgt_self | passive | OK |
| Ranger | Dead Eye | Killzone | Utility | buff_stat | tgt_self | llm | OK |
| Ranger | Dead Eye | Cold Calculation | Buff | buff_stat | tgt_self | llm | OK |
| Ranger | Dead Eye | Sniper's Patience | Channel | dmg_weapon | tgt_single_enemy | llm | OK |
...
| Ranger | Trapper | Snare Trap | Utility | cc_root | tgt_single_enemy | llm | OK |
| Ranger | Trapper | Tripwire | Utility | debuff_stat | tgt_single_enemy | llm | OK |
| Ranger | Trapper | Bait Pile | Utility | cc_daze | tgt_single_enemy | llm | OK |
| Ranger | Trapper | Spike Pit | Active | debuff_stat, dot_bleed, cc_daze | tgt_single_enemy | llm | OK |
| Ranger | Trapper | Cluster Mine | Utility | dmg_multihit | tgt_aoe_adjacent | llm | OK |
| Ranger | Trapper | Marked Ground | Passive |  | tgt_self | passive | OK |
| Ranger | Trapper | Chain Reaction | Passive |  | tgt_self | passive | OK |
| Ranger | Trapper | Corrosive Net | CC | cc_root, debuff_vuln | tgt_single_enemy | llm | OK |
| Ranger | Trapper | Prepared Ground | Buff | res_apRefund | tgt_self | llm | OK |
| Ranger | Trapper | Killbox Setup | Active | dmg_weapon, cc_root | tgt_aoe_adjacent | llm | OK |
| Ranger | Trapper | Phantom Traps | Passive |  | tgt_self | passive | OK |
| Ranger | Trapper | The Long Game | Active | dmg_multihit, cc_root | tgt_aoe_adjacent | llm | OK |
| Ranger | Beastmaster Archer | Bond Strike | Attack | dmg_weapon, dmg_weapon | tgt_single_enemy | llm | OK |
| Ranger | Beastmaster Archer | Scout Hawk | Summon | debuff_stat | tgt_aoe_adjacent | llm | OK |
...
| Ranger | Beastmaster Archer | Heal Companion | Heal | heal_pctDmg | tgt_single_ally | llm | OK |
...
| Ranger | Beastmaster Archer | Scatter Drive | Active | dmg_weapon, debuff_stat, disp_push | tgt_aoe_adjacent | llm | OK |
...
| Ranger | Beastmaster Archer | Hunt as One | Transform | buff_stat, dmg_weapon, dmg_weapon | tgt_self | llm | OK |
