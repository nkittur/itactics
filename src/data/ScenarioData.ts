  ...
  // ── 1. Tutorial: 3v3 on flat ground ──
  {
    ...
    units: [
      ...
      { q: 1, r: 2, team: "player", name: "Swordsman",
        ...
        sprite: "swordsman", classId: "berserker", bag: ["health_potion"] },
      { q: 1, r: 4, team: "player", name: "Axeman",
        ...
        sprite: "armored-axeman", classId: "berserker", bag: ["health_potion"] },
  ...
  // ── 2. Hill Assault: 4v5, enemies on elevation ──
  {
    ...
    units: [
      ...
      { q: 1, r: 5, team: "player", name: "Maceman",
        ...
        sprite: "soldier", classId: "berserker", bag: ["health_potion"] },
